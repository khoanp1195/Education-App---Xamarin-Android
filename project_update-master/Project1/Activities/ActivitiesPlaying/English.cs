...
namespace Project1.Acitivties.ActivitiesPlaying
{
    ...
    public class English : Activity, IOnClickListener
    {
        ...
        protected override void OnResume()
        {
            base.OnResume();
            index = 0;
            questionPlay = db.GetEnglishQuestionMode(mode);
        ...
        public class CountDown : CountDownTimer
        {
            ...
            public CountDown(English playing, long totalTime, long interval) : base(totalTime, interval)
            {
