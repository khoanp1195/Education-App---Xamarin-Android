...
namespace Project1.Acitivties.ActivitiesPlaying
{
    ...
    public class UserAddQuestion : Activity, IOnClickListener
    {
        ...
        protected override void OnResume()
        {
            base.OnResume();
            index = 0;
            questionPlay = db.GetUserIQQuestionMode(mode);
       ...
       public class CountDown : CountDownTimer
        {
            UserAddQuestion playing;
            

            public CountDown(UserAddQuestion playing, long totalTime, long interval) : base(totalTime, interval)
            {
