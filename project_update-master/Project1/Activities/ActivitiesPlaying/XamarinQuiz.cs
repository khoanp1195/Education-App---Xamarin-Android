...
namespace Project1.Acitivties.ActivitiesPlaying
{
    ...
    public class XamarinQuiz : Activity, IOnClickListener
    {
        ...
        List<QuestionXamrin> questionPlay = new List<QuestionXamrin>();
        ...
        protected override void OnResume()
        {
            base.OnResume();
            index = 0;
            questionPlay = db.GetXamarinQuestionMode(mode);
        ...
        public void ShowQuestion(int index)
        {
            ...
            {
                //{
                Intent intent = new Intent(this, typeof(DoneXamarin));
        ...
        public class CountDown : CountDownTimer
        {
            ...
            public CountDown(XamarinQuiz playing, long totalTime, long interval) : base(totalTime, interval)
            {
