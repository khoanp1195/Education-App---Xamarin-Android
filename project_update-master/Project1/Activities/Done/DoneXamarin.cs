...
namespace Project1.Activities
{
    ...
    public class DoneXamarin : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            if (bundle != null)
            {
                ...
                //Save score
                db.InsertXamarinScore(finalScore);
            }
        }
        ...
        private void Sentscore_Click(object sender, EventArgs e)
        {
            ...
            DatabaseReference newAluminRef = AppDataHelper.GetDatabase().GetReference("UserXamarinRanking").Push();
