...
namespace Project1.Activities.Intro
{
    ...
    public class IntroMath : Activity,IOnSeekBarChangeListener
    {
        SeekBar seekBar;
        TextView txtMode;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView (Resource.Layout.intro_math);
            ...
            back = FindViewById<ImageView>(Resource.Id.backButton);
            ...
            btnPlay.Click += delegate {
                Intent intent = new Intent(this, typeof(XamarinQuiz));
