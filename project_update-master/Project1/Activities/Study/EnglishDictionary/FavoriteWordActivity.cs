...
namespace Project1
{
    ...
    public class FavoriteWordActivity : AppCompatActivity
    {
        ListView lstView;
        ImageView addButton;
        ...
        EditText edtSearch;
        ImageView imgSearch;
        List<FavoriteWord> listItsms = null;
      ...
      //  AddQuestionQuizzDialogFragment addQuestionQuizzDialogFragment;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                DbHelper.DbHelper db = new DbHelper.DbHelper(this);
                List<FavoriteWord> lstQuestion = db.GetFavoriteEnglishWord();
                if (lstQuestion.Count > 0)
                {
                    FavoriteWordCustomAdapter adapter = new FavoriteWordCustomAdapter(this, lstQuestion);
            ...
            {
                Snackbar snackbar = Snackbar.Make(relativeLayout1, "Add Failed", Snackbar.LengthShort);
       ...
       .Rotation(0f);
        ...
        private void LoadQuestionList()
        {
            ...
            {
                listItsms = dbVals.GetFavoriteEnglishWord();
            }
            else
            {
