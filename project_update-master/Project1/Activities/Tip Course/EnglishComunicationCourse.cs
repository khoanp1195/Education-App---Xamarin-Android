...
namespace Project1.Activities.AddQuestionQuizz
{
    ...
    public class EnglishComunicationCourse : AppCompatActivity
    {
        ...
        EditText edtSearch;
        ImageView imgSearch, playButton;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            playButton = (ImageView)FindViewById(Resource.Id.playButton);
     ...
     //       addButton.Click += AddButton_Click;
        ...
        {
            Intent intent = new Intent(this, typeof(EnglisClip));
        ...
        private void SetUpViewPager(ViewPager viewPager)
        {
            ...
            adapter.AddFragment(new NormalComunication(), "Norlmal");
            adapter.AddFragment(new AdvancedComunication(), "Advanced");
