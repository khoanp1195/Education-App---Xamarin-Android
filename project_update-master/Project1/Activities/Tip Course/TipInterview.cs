...
namespace Project1.Activities.AddQuestionQuizz
{
    ...
    public class TipInterview : AppCompatActivity
    {
        ...
        {
            Intent intent = new Intent(this, typeof(XamarinClip));
        ...
        private void SetUpViewPager(ViewPager viewPager)
        {
            ...
            adapter.AddFragment(new XamarinAdvancedInterviewFragment(), "Android");
