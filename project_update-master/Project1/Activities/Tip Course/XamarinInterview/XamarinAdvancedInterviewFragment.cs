...
namespace Project1
{
    public class XamarinAdvancedInterviewFragment : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            List<XamarinInterview> lstQuestion = db.GetXamarinAdvancedQuestions();
        ...
        private void LoadQuestionList()
        {
            DbHelper.DbHelper dbVals = new DbHelper.DbHelper(Context);
                ...
                listItsms = dbVals.GetXamarinAdvancedQuestions();
