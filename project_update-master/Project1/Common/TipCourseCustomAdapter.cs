...
namespace Project1.Common
{
    ...
    class TipCourseCustomAdapter : BaseAdapter
    {
        private List<XamarinInterview> lsIQQuestion;
        private Context context;


     
        public TipCourseCustomAdapter(Context context, List<XamarinInterview> lsIQQuestion)
        {
