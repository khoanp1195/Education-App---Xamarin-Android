...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Project1.Adapter.NotesAdapter, Project1", NotesAdapter.class, __md_methods);
	}
	...
	public NotesAdapter ()
	{
		...
		if (getClass () == NotesAdapter.class)
			mono.android.TypeManager.Activate ("Project1.Adapter.NotesAdapter, Project1", "", this, new java.lang.Object[] {  });
	}
