...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Project1.Adapter.PostAdapter, Project1", PostAdapter.class, __md_methods);
	}
	...
	public PostAdapter ()
	{
		...
		if (getClass () == PostAdapter.class)
			mono.android.TypeManager.Activate ("Project1.Adapter.PostAdapter, Project1", "", this, new java.lang.Object[] {  });
	}
