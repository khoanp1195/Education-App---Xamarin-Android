...
public class FavoriteWordActivity_FabAnimatorListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Project1.FavoriteWordActivity+FabAnimatorListener, Project1", FavoriteWordActivity_FabAnimatorListener.class, __md_methods);
	}


	public FavoriteWordActivity_FabAnimatorListener ()
	{
		super ();
		if (getClass () == FavoriteWordActivity_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("Project1.FavoriteWordActivity+FabAnimatorListener, Project1", "", this, new java.lang.Object[] {  });
	}

	public FavoriteWordActivity_FabAnimatorListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == FavoriteWordActivity_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("Project1.FavoriteWordActivity+FabAnimatorListener, Project1", "Android.Views.View[], Mono.Android", this, new java.lang.Object[] { p0 });
	}
