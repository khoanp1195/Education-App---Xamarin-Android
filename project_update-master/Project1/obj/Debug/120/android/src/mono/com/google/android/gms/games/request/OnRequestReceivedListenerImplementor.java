...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Gms.Games.Request.IOnRequestReceivedListenerImplementor, Xamarin.GooglePlayServices.Games", OnRequestReceivedListenerImplementor.class, __md_methods);
	}


	public OnRequestReceivedListenerImplementor ()
	{
		super ();
		if (getClass () == OnRequestReceivedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Android.Gms.Games.Request.IOnRequestReceivedListenerImplementor, Xamarin.GooglePlayServices.Games", "", this, new java.lang.Object[] {  });
	}
