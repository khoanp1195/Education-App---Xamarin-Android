...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Gms.Games.Video.IVideosCaptureOverlayStateListenerImplementor, Xamarin.GooglePlayServices.Games", Videos_CaptureOverlayStateListenerImplementor.class, __md_methods);
	}


	public Videos_CaptureOverlayStateListenerImplementor ()
	{
		super ();
		if (getClass () == Videos_CaptureOverlayStateListenerImplementor.class)
			mono.android.TypeManager.Activate ("Android.Gms.Games.Video.IVideosCaptureOverlayStateListenerImplementor, Xamarin.GooglePlayServices.Games", "", this, new java.lang.Object[] {  });
	}
